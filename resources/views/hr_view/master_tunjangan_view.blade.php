                                ...
                                <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false" role="widget">
                                    ...
                                    <div role="content">
                                        ...
                                        <div class="widget-body">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <form method="post" class="form-horizontal" action="{{url('/store_tunjangan')}}" id="employee_form">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="col-sm-4 control-label">
                                                                    Nama Divisi</label>
                                                                <div class="col-sm-7">
                                                                    <input class="form-control" required="" type="text" placeholder="Nama Tunjangan" name="nama_divisi" id="nama_divisi" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-4 control-label">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <table id="dt_basic_1" class="table table-striped table-bordered table-hover" width="100%">
                                                    ...
                                                    <tbody id="isiTableedit">
                                                        ...
                                                        <tr>
                                                            <td>{{$no++}}</td>
                                                            <td>{{$div->jenis_parameter}}</td>
                                                            <td>
                                                                <center>
                                                                    <button type="button" data-item="{{$div->id}}" id="edit_barang" onclick="modal_employee(this)" class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Ubah
                                                                    </button>
                                                                </center>
                                                            </td>
                                                        </tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background: #1aa3ff">
                <h2 class="modal-title" id="myModalLabel" style="color: whitesmoke;">Ubah Nama Tunjangan</h2>
            </div>
            <form id="verif_invoice" class="form-horizontal" action="{{url('/update_tunjangan')}}" method="POST">
...
<script>
    ...
    function modal_employee(button) {
        ...
        //alert(id_supp);
        $.get('{{URL::to("/get_data_tunjangan/")}}/' + btoa(id), function(data) {
            json = JSON.parse(data);
            console.log(json);
            $('#id_emp_edit').val(json[0].id);
            $('#divisi_name_edit').val(json[0].jenis_parameter);
        });
    }
</script>
@endsection
                                ...
                                <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-x" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-sortable="false" role="widget">
                                    ...
                                    <div role="content">
                                        ...
                                        <div class="widget-body">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <form method="post" class="form-horizontal" action="{{url('/store_penilaian')}}" id="employee_form">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input class="form-control" required="" type="text" placeholder="Nama Parameter Penilaian" name="nama_parameter" id="nama_parameter" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <select class="form-control select2" required="" name="position">
                                                                        <option></option>
                                                                        @foreach($sub_nilai as $div)
                                                                        <option value="{{$div->id_sub_penilaian}}">{{$div->kategori_penilaian}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <table id="dt_basic_1" class="table table-striped table-bordered table-hover" width="100%">
                                                    ...
                                                    <tbody id="isiTableedit">
                                                        @foreach($parameter_penilaian as $div)
                                                        <tr>
                                                            <td>{{$no++}}</td>
                                                            <td>{{$div->parameter_penilaian}}</td>
                                                            <td>{{$div->kategori_penilaian}}</td>
                                                            <td>
                                                                <center>
                                                                    <button type="button" data-item="{{$div->id_penilaian}}" id="edit_barang" onclick="modal_employee(this)" class="btn btn-primary btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Ubah
                                                                    </button>
                                                                </center>
                                                            </td>
                                                        </tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background: #1aa3ff">
                <h2 class="modal-title" id="myModalLabel" style="color: whitesmoke;">Ubah Parameter Penilaian</h2>
            </div>
            <form id="verif_invoice" class="form-horizontal" action="{{url('/update_penilaian')}}" method="POST">
...
<script>
    ...
    function modal_employee(button) {
        ...
        //alert(id_supp);
        $.get('{{URL::to("/get_data_penilaian/")}}/' + btoa(id), function(data) {
            json = JSON.parse(data);
            console.log(json);
            $('#id_emp_edit').val(json[0].id_penilaian);
            $('#nama_emp_edit').val(json[0].parameter_penilaian);
            $('#position_edit').val(json[0].sub_penilaian).change();
        });
    }
</script>
@endsection